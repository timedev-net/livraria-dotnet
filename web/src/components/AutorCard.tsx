...
export default function AutorCard(props: any) {
  ...
  <>
    <div className="z-40 flex flex-wrap gap-8 ml-3">
      <div className="overflow-visible border rounded-xl w-80 p-2 bg-gradient-to-r from-indigo-100 to-emerald-100 to-90%">
        ...
        <h1 className="cursor-pointer text-xl leading-6 mb-1 font-semibold hover:text-gray-500">Frota, Daniel</h1> 
        {/* <p className="font-semibold"></p> */}
        {/* <p className="text-sm font-semibold mb-2">Possui 5 livros disponíveis à venda</p> */}
        <p className="text-sm mb-2">Ficção Científica, Terror</p>
        <p className="font-mono font-semibold text-right"><span className='text-4xl'>15</span> livros</p>
        <p className="font-mono  text-right">Disponívels à venda!</p>
