...
export default function LivroForm(props: any) {
  ...
  async function onSubmit(data: any) {
    ...
    if (idParam) {
      ...
      console.log({ ...data, preco: +data.preco.replace(',', '.'), autoresId, generosId })
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center mx-10 w-full">
        ...
        <div className="block w-max p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex justify-around">
              <div className="my-6">
                <button onClick={() => setDropAutores(!dropAutores)} className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800" type="button">
                  Selecione os autores
                </button>
                <div className={`${!dropAutores && 'hidden'} z-10 bg-white rounded-lg shadow w-60 dark:bg-gray-700`}>
                  <ul className="h-48 px-3 pb-3 overflow-y-auto text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownSearchButton">
                    {autoresList.map((e: any, i: number) => (
                      <li key={e.id}>
                        <div className="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                          <input id={`generos.${i}`} onChange={() => handleAutoresCheck(e)} checked={e.checked} type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
              ...
              <div className="my-6">
                <button onClick={() => setDropGeneros(!dropGeneros)} className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800" type="button">
                  Selecione os generos
                </button>
                <div className={`${!dropGeneros && 'hidden'} z-10 bg-white rounded-lg shadow w-60 dark:bg-gray-700`}>
                  <ul className="h-48 px-3 pb-3 overflow-y-auto text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownSearchButton">
